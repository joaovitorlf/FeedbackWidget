    ...
    return(
        <>
            ...
            <div className="flex flex-col items-center py-10 w-[304px]">
                ...
                hover:bg-zinc-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zinc-900 focus:ring-brand-600
                hover:outline-none hover:ring-2 hover:ring-offset-2 hover:ring-offset-zinc-900 hover:ring-brand-500"
                >
                    Desejo enviar outro
                </button>
            </div>
